...
```
    ...
    ## # A tibble: 3 × 7
    ##   wheel_name   first_date          dumpster_count total_vol max_vol total_weight
    ##   <fct>        <dttm>                       <int>     <dbl>   <dbl>        <dbl>
    ## 1 Mr. Trash W… 2014-05-16 00:00:00            651      9919      20        2091.
    ## 2 Professor T… 2017-01-02 00:00:00            118      1716      18         247.
    ## 3 Gwynnda Tra… 2021-07-03 00:00:00            262      3924      15         798.
    ## # ℹ 1 more variable: max_weight <dbl>
...
```
    ...
    ## # A tibble: 3 × 9
    ##   wheel_name       total_plastic_bottles total_polystyrene total_cigarette_butts
    ##   <fct>                            <dbl>             <dbl>                 <dbl>
    ## 1 Mr. Trash Wheel                1280075            927411              11806700
    ## 2 Professor Trash…                593246            446455               1277478
    ## 3 Gwynnda Trash W…                396227             52054                623920
    ## # ℹ 5 more variables: total_glass_bottles <dbl>, total_plastic_bags <dbl>,
    ## #   total_wrappers <dbl>, total_sports_balls <int>, total_homes_powered <dbl>

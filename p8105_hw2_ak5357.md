...
| wheel_name            | first_date | dumpster_count | total_vol | max_vol | total_weight | max_weight |
|:----------------------|:-----------|---------------:|----------:|--------:|-------------:|-----------:|
...
| wheel_name            | total_plastic_bottles | total_polystyrene | total_cigarette_butts | total_glass_bottles | total_plastic_bags | total_wrappers | total_sports_balls | total_homes_powered |
|:----------------------|----------------------:|------------------:|----------------------:|--------------------:|-------------------:|---------------:|-------------------:|--------------------:|
...
the same person as *Joanne* in `results_df` and *Jo Wheatly* in
...
results of eliminated contestants) from there.
...
```
    ...
    ##  3      1       1 David   Chocolate Orange Cake    "Black Fore…         3 IN    
    ##  4      1       2 David   Cheddar Cheese and Fres… "Choux Past…         8 IN    
    ##  5      1       3 David   Chilli Bread             "Walnut and…         4 IN    
    ##  6      1       4 David   Pear and Walnut Pudding  "Apple and …         5 OUT   
    ##  7      1       1 Edd     Caramel Cinnamon and Ba…  <NA>                1 IN    
    ##  8      1       2 Edd     Oatmeal Raisin Cookie    "Pink Macar…         6 IN    
    ##  9      1       3 Edd     Olive Bread              "Tomato and…         1 IN    
    ## 10      1       4 Edd     Apple and Plum Pudding   "Apple and …         3 IN
...
That was a long process. In my final code, I would have done it as shown
below, all in one go.
...
knitr::kable(gbb_winners)
```

| series | episode | baker_firstname | baker_lastname  | result     |
|-------:|--------:|:----------------|:----------------|:-----------|
...
1 was 2.77. The average viewership in Season 5 was 10.0393.
